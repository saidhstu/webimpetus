                        ...
                        <div class="header_more_tool">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" onclick="return confirm('Are you sure want to delete?');" href="/customers/delete/<?= $row['id'];?>"> <i class="ti-trash"></i> Delete</a>
                                    <a class="dropdown-item" href="/customers/edit/<?= $row['id'];?>"> <i class="fas fa-edit"></i> Edit</a>
