                                        ...
                                        <div class="col-md-6">
                                            <select id="client_id" name="client_id" class="form-control required dashboard-dropdown">
                                                ...
                                                <?php foreach($customers as $row):?>
                                                    <option value="<?= $row['id'];?>" <?php if($row['id'] == @$work_order->client_id){ echo "selected"; }?>><?= $row['company_name'];?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group row-space ">
                                        ...
                                        <select id="template" name="template" class="form-control  dashboard-dropdown">
                                            ...
                                            <?php foreach($templates as $row):?>
                                                <option value="<?= $row['id'];?>" <?php if($row['id'] == @$work_order->template){ echo "selected"; }?>><?= $row['code'];?></option>
                                            <?php endforeach;?>
                                        </select> 
                                    </div>
                                    </div>
                                ...
                                <div class="row form-group row-space ">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php foreach($status as $key => $value):?>
                                                <option value="<?= $key;?>" <?php if($key == @$work_order->status){ echo "selected"; }?>><?= $value;?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                </div>
