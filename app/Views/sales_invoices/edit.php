                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="date" class="form-control datepicker" value="<?=@$sales_invoice->date?>" id="date" name="date" placeholder="">
                                    </div>

                                    <div class="form-group ">
                                        <label for="inputEmail4">Due Date*</label>
                                        <input type="date" class="form-control datepicker" id="due_date" name="due_date" placeholder="" value="<?=@$sales_invoice->due_date?>">
                                    </div>
