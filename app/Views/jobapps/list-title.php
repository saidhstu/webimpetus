            ...
            <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                <div class="page_title_left d-flex align-items-center">
                    ...
                    <ol class="breadcrumb page_bradcam mb-0">
                        ...
                        <?php echo render_head_text("job_applications"); ?>  </a></li>
                    </ol>
                </div>
                <div class="page_title_right">
                    ...
                    <div class="header_more_tool setDropDownBlk">
                        ...
                        <?php }else{?>
                            <a href="/<?php echo $tableName; ?>/edit" class="btn btn-primary"><i class="ti-plus"></i> Add <?php echo render_head_text("job_application"); ?></a>
                        <?php }?>
