                                        ...
                                        <div class="col-md-6">
                                            <select id="client_id" name="client_id" class="form-control required dashboard-dropdown">
                                                ...
                                                <?php foreach($customers as $row):?>
                                                    <option value="<?= $row['id'];?>" <?php if($row['id'] == @$purchase_invoice->client_id){ echo "selected"; }?>><?= $row['company_name'];?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <select id="print_template_code" name="print_template_code" class="form-control  dashboard-dropdown">
                                            ...
                                            <?php foreach($templates as $row):?>
                                                <option value="<?= $row['id'];?>" <?php if($row['id'] == @$purchase_invoice->print_template_code){ echo "selected"; }?>><?= $row['code'];?></option>
                                            <?php endforeach;?>
                                        </select> 
                                    </div>
                                </div>
