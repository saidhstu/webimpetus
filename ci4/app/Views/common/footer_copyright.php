        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="DOCKER_REGISTRYiner text-center">
                    ...
                    <p>
                        WebImpetus Version: <a target="_blank" href="<?php echo $appReleaseNotesDocURL; ?>"><?php echo getenv('APP_FULL_VERSION_NO') . " build " . getenv('APP_FULL_BUILD_NO'); ?></a>,&nbsp;Deployment timestamp: <?php echo getenv('APP_DEPLOYED_AT'); ?>
                    </p>
                </div>
            </div>
        </div>
